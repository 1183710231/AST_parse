...
public class ClicyAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		if (selection instanceof IStructuredSelection) {
			ICompilationUnit fileUnit = (ICompilationUnit) ((IStructuredSelection) selection).getFirstElement();
			createActionExuecutable(action.getId().add(),fileUnit);
	...
	private void createActionExuecutable(String id,ICompilationUnit fileUnit) {
	    int id =20;
	    String s = '100';
		if ("com.aasis21.app.ASTAction".equals(id, s)){
